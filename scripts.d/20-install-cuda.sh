...
aria2c -x16 -s16 https://developer.download.nvidia.com/compute/cuda/11.7.0/local_installers/cuda-repo-ubuntu2204-11-7-local_11.7.0-515.43.04-1_amd64.deb
apt-get install -y ./cuda-repo-ubuntu2204-11-7-local_11.7.0-515.43.04-1_amd64.deb
